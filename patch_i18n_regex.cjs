...
for (const lang of ['en', 'es', 'fr', 'pt']) {
  // Regex to find the partnerLoginContent block for the current language
  // The structure is roughly: "en": { ... "partnerLoginContent": { ... }, ...
  // But wait, there is a safer way.
  // We can just parse the file using `Function` after slicing.
}
