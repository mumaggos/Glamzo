...
for (const lang of ['en', 'es', 'fr', 'pt']) {
  const marker = '"partnerLoginContent": {';
  // we want to find the partnerLoginContent object for the given lang
  // but it's easier to just do a string replacement on the whole file using regex since the file is large
  // wait, finding the right lang block is tricky with regex.
}
