...
// I will extract everything up to `export default function App() {`
// Then I will reconstruct `App` exactly.
...
console.log('Force replaced App.tsx rendering to 100% clean!');
