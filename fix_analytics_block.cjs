...
const regex = /\{\/\* Aggregate Platform Billing line diagram \*\/\}[\s\S]*?\{\/\* SECTION 3: PAYOUTS/;
const goodBlock = `{/* Aggregate Platform Billing line diagram */}
...
console.log('Fixed analytics block');
