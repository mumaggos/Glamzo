...
# Add new imports
text = text.replace("import { ShieldAlert", "import { ShieldAlert, Send, Paperclip, Loader2, Image as ImageIcon")
text = text.replace("import React, { useState, useEffect }", "import React, { useState, useEffect, useRef }")

# Add state
state_target = r"const \[selectedDispute, setSelectedDispute\] = useState<any>\(null\);"
new_state = """const [selectedDispute, setSelectedDispute] = useState<any>(null);
