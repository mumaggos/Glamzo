...
export default function Footer() {
  return (
    <footer className="border-t border-slate-100 py-12 mt-auto bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 pb-8 border-b border-slate-100">
          ...
          <div>
            <h4 className="font-bold text-slate-900 mb-4">Informação Legal</h4>
            <ul className="flex flex-col gap-2 text-sm text-slate-600">
              ...
              <li><Link to="/politica-de-privacidade" className="hover:text-purple-600 focus:outline-none focus:underline">Política de Privacidade (GDPR)</Link></li>
              <li><Link to="/politica-de-cookies" className="hover:text-purple-600 focus:outline-none focus:underline">Política de Cookies</Link></li>
              <li><Link to="/seguranca-e-protecao-de-dados" className="hover:text-purple-600 focus:outline-none focus:underline">Segurança e Proteção de Dados</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold text-slate-900 mb-4">Condições de Serviço</h4>
            <ul className="flex flex-col gap-2 text-sm text-slate-600">
              <li><Link to="/politica-de-pagamentos" className="hover:text-purple-600 focus:outline-none focus:underline">Política de Pagamentos</Link></li>
              <li><Link to="/politica-de-cancelamentos" className="hover:text-purple-600 focus:outline-none focus:underline">Cancelamentos e Reembolsos</Link></li>
            </ul>
          </div>
        </div>
