              ...
              {step === 4 && (
                <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
                  {availableSlots.length === 0 ? (
                    <div className="col-span-full p-8 text-center bg-white rounded-2xl border border-slate-200"><Clock className="w-8 h-8 text-slate-400 mx-auto mb-2"/><p className="font-bold text-slate-700">{t('no_available_times') || 'Sem horários disponíveis'}</p></div>
                  ) : (
