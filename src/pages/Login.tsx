        ...
        <div className="bg-white py-8 px-4 border border-slate-200/60 rounded-3xl shadow-sm sm:px-10">
          ...
          <form className="space-y-5" onSubmit={handleEmailLogin}>
            <div>
              <label htmlFor="email-address-input" className="block text-xs font-bold text-slate-600 uppercase tracking-wider mb-2">
                Endereço de {t('auth.login.emailLabel')}
              </label>
            ...
            >
              {loading ? <><Loader2 className="w-4 h-4 animate-spin" />{t('auth.login.loggingIn')}</> : <span>{t('auth.login.loginBtn')}</span>}
            </button>
          </form>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs"><span className="px-3 bg-white text-slate-400 font-bold uppercase tracking-wider">{t('auth.login.orLoginWith')}</span></div>
            </div>
