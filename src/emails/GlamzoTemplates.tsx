...
export const VerificationCodeEmail = ({ userName, code }: any) => { 
  ...
  <Html>
    <Head />
    <Preview>{t("verificationCode", lang)} Glamzo</Preview>
    <Body style={mainStyles}>
      <Container style={containerStyles}>
        <Heading style={{...headingStyles, color: PRIMARY_COLOR}}>Glamzo</Heading>
        <Heading style={headingStyles}>{t("welcome", lang)} {userName}!</Heading>
...
export const VerificationEmail = ({ userName, confirmationLink }: any) => { 
  ...
  <Html>
    <Head />
    <Preview>{t("confirmEmailPreview", lang)}</Preview>
    <Body style={mainStyles}>
      <Container style={containerStyles}>
        <Heading style={{...headingStyles, color: PRIMARY_COLOR}}>Glamzo</Heading>
        <Heading style={headingStyles}>{t("welcome", lang)} {userName}!</Heading>
...
export const PasswordResetEmail = ({ userName, resetLink }: any) => { 
  ...
  <Html>
    <Head />
    <Preview>{t("passResetPreview", lang)}</Preview>
    <Body style={mainStyles}>
      <Container style={containerStyles}>
        <Heading style={{...headingStyles, color: PRIMARY_COLOR}}>Glamzo</Heading>
        <Heading style={headingStyles}>{t("hello", lang)}, {userName}</Heading>
        <Text style={textStyles}>
